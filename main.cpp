...
// =============================================================================
//  Обёртки для модулей AES и Serpent (их точки входа называются иначе)
// =============================================================================

// aes_run_ui() объявлена в AES/ui/aes_ui.h
void aes_run_ui();
void runAES() { aes_run_ui(); }

// serpent_run_ui() объявлена в Serpent/ui/serpent_ui.h
void serpent_run_ui();
void runSerpent() { serpent_run_ui(); }
