...
SERPENT_API void serpent_expand_key(const unsigned char* cipher_key, unsigned int* subkeys);

// Шифрование одного блока (16 байт)
SERPENT_API void serpent_encrypt_block(const unsigned char* input, unsigned char* output, const unsigned int* subkeys);

// Дешифрование одного блока (16 байт)
SERPENT_API void serpent_decrypt_block(const unsigned char* input, unsigned char* output, const unsigned int* subkeys);
